...
export basedir=/mnt/isilon/maris_lab/target_nbl_ngs/PBTA/gistic/2019-12-10-gistic-results-cnvkit/

mkdir $basedir
echo --- running GISTIC ---

#specify segfile
export segfile=/mnt/isilon/maris_lab/target_nbl_ngs/PBTA/pbta-cnv-cnvkit.seg
